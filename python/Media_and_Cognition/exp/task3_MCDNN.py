...
class Model:
    ...
    def __init__(self, data_path, classes, config):
        ...
        self.optimizer = optim.Adam(itertools.chain(self.net1.parameters(), self.net2.parameters(),
                                                    self.net3.parameters(), self.net4.parameters(),
                                                    self.net5.parameters()), lr=self.learning_rate)
    ...
    def load_best_model(self):
        ...
        self.net4.load_state_dict(state['net4'])
        self.net5.load_state_dict(state['net5'])
...
if __name__ == "__main__":
    ...
    train_path = '/home/ass02/Datasets/image_exp/Classification/DataFewShot/Train/'
    ...
    config_dict = {'batch_size': 1,
                   ...
                   'epoch_num': 40,
                   'validation_epochs': 5}
    model = Model(data_path=train_path, classes=classes, config=config_dict)
    model.load_best_model()
    num_ftrs = model.net1.module.fc3_1.in_features
    model.net1.module.fc3_1 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net1.module.fc3_2.in_features
    model.net1.module.fc3_2 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net1.module.fc3_3.in_features
    model.net1.module.fc3_3 = nn.Linear(num_ftrs, 11)
    ...
    model.net2.module.fc3_2 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net2.module.fc3_3.in_features
    model.net2.module.fc3_3 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net2.module.fc3_4.in_features
    model.net2.module.fc3_4 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net2.module.fc3_5.in_features
    model.net2.module.fc3_5 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net3.module.fc3_1.in_features
    model.net3.module.fc3_1 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net3.module.fc3_2.in_features
    model.net3.module.fc3_2 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net3.module.fc3_3.in_features
    model.net3.module.fc3_3 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net3.module.fc3_4.in_features
    model.net3.module.fc3_4 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net3.module.fc3_5.in_features
    model.net3.module.fc3_5 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net4.module.fc3_1.in_features
    model.net4.module.fc3_1 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net4.module.fc3_2.in_features
    model.net4.module.fc3_2 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net4.module.fc3_3.in_features
    model.net4.module.fc3_3 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net4.module.fc3_4.in_features
    model.net4.module.fc3_4 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net4.module.fc3_5.in_features
    model.net4.module.fc3_5 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net5.module.fc3_1.in_features
    model.net5.module.fc3_1 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net5.module.fc3_2.in_features
    model.net5.module.fc3_2 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net5.module.fc3_3.in_features
    model.net5.module.fc3_3 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net5.module.fc3_4.in_features
    model.net5.module.fc3_4 = nn.Linear(num_ftrs, 11)
    num_ftrs = model.net5.module.fc3_5.in_features
    model.net5.module.fc3_5 = nn.Linear(num_ftrs, 11)
    ignored_params = list(map(id,
                              list(model.net1.module.fc3_1.parameters()) + list(model.net1.module.fc3_2.parameters()) + list(model.net1.module.fc3_3.parameters()) +
                              list(model.net1.module.fc3_4.parameters()) + list(model.net1.module.fc3_5.parameters()) +
                              list(model.net2.module.fc3_1.parameters()) + list(model.net2.module.fc3_2.parameters()) + list(model.net2.module.fc3_3.parameters()) +
                              list(model.net2.module.fc3_4.parameters()) + list(model.net2.module.fc3_5.parameters()) +
                              list(model.net3.module.fc3_1.parameters()) + list(model.net3.module.fc3_2.parameters()) + list(model.net3.module.fc3_3.parameters()) +
                              list(model.net3.module.fc3_4.parameters()) + list(model.net3.module.fc3_5.parameters()) +
                              list(model.net4.module.fc3_1.parameters()) + list(model.net4.module.fc3_2.parameters()) + list(model.net4.module.fc3_3.parameters()) +
                              list(model.net4.module.fc3_4.parameters()) + list(model.net4.module.fc3_5.parameters()) +
    ...
    model.optimizer = optim.Adam([{'params': base_params},
                                  {'params': model.net1.module.fc3_1.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net1.module.fc3_2.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net1.module.fc3_3.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net1.module.fc3_4.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net1.module.fc3_5.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net2.module.fc3_1.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net2.module.fc3_2.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net2.module.fc3_3.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net2.module.fc3_4.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net2.module.fc3_5.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net3.module.fc3_1.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net3.module.fc3_2.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net3.module.fc3_3.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net3.module.fc3_4.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net3.module.fc3_5.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net4.module.fc3_1.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net4.module.fc3_2.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net4.module.fc3_3.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net4.module.fc3_4.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net4.module.fc3_5.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net5.module.fc3_1.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net5.module.fc3_2.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net5.module.fc3_3.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net5.module.fc3_4.parameters(),
                                   'lr': 0.001},
                                  {'params': model.net5.module.fc3_5.parameters(), 'lr': 0.001}, ], lr=0)
    model.net1 = torch.nn.DataParallel(
        model.net1, device_ids=model.gpus).cuda()
    model.net2 = torch.nn.DataParallel(
        model.net2, device_ids=model.gpus).cuda()
    model.net3 = torch.nn.DataParallel(
        model.net3, device_ids=model.gpus).cuda()
    model.net4 = torch.nn.DataParallel(
        model.net4, device_ids=model.gpus).cuda()
    model.net5 = torch.nn.DataParallel(
        model.net5, device_ids=model.gpus).cuda()
    model.train()
